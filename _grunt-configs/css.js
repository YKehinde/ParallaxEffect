...
module.exports.tasks = {
	...
	sass: {
		kickoff: {
			...
			files: {
				'<%=config.css.distDir%>/temp/p-lax.css' : '<%=config.css.scssDir%>/<%=config.css.srcFile%>.scss',
				'<%=config.css.distDir%>/temp/p-lax-old-ie.css': '<%=config.css.scssDir%>/<%=config.css.srcFile%>-old-ie.scss'
			}
		},
		styleguide: {
			options: {
	...
	csso: {
		dist: {
			...
			files: {
				'<%=config.css.distDir%>/p-lax.css' : '<%=config.css.distDir%>/p-lax.css',
				'<%=config.css.distDir%>/p-lax-old-ie.css': '<%=config.css.distDir%>/p-lax-old-ie.css'
			},
		}
	}
};
